                          ...
                          <div class="totals-section">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <input type="number" class="form-control form-control-sm" id="discount"
                                  v-model.number="serviceInfo.discount" placeholder="Discount value">
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="discount_type" class="col-sm-5 col-form-label text-right">Discount Type:</label>
                              <div class="col-sm-7">
                                <select v-model="serviceInfo.discount_type" class="form-control form-control-sm"
                                  id="discount_type">
                            ...
                            <div class="form-group row">
                              <label for="payment_status_bottom" class="col-sm-5 col-form-label text-right">Payment
                                Status:</label>
                              <div class="col-sm-7">
                                <select v-model="serviceInfo.payment_status" class="form-control form-control-sm"
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <select v-model="serviceInfo.status" class="form-control form-control-sm"
                                  id="status_bottom">
  ...
  export default {
    setup() {
      ...
      const subTotal = computed(() => {
        return serviceInfo.dataItem.reduce((acc, item) => {
      ...
      // Watch grandTotal to upservice_date serviceInfo.total_amount
      watch(grandTotal, (newTotal) => {
        serviceInfo.total_amount = newTotal;
      });
